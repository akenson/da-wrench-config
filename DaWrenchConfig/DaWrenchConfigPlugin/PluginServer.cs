...
{
    [Guid("1f37e3d6-b6c0-4526-a5cc-2d7790e3fe6f")]
    public class PluginServer : ApplicationAddInServer
    {
        ...
        {
            Trace.TraceInformation(": DaWrenchConfigPlugin (" + Assembly.GetExecutingAssembly().GetName().Version.ToString(4) + "): initializing... ");
        ...
        {
            Trace.TraceInformation(": DaWrenchConfigPlugin: deactivating... ");
